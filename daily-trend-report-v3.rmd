...
```{r Insert Canada case per 100K, fig.cap=paste(key_100k_caption), echo=FALSE, results = 'asis', message=FALSE, warning=FALSE, out.width='100%'}
...
```
Highlights:
Over the past week, a daily average of `r scales::comma(key_Can_weekly_tests/7)` tests have been performed for COVID-19 across Canada, for a total of `r scales::comma(key_Can_weekly_tests)` tests. The weekly percent positivity is `r key_Can_weekly_perc_positive`

```{r National Testing Graphic, fig.cap=paste0("Updated daily (Sun-Thurs). Data as of ",key_lab_update),echo=FALSE, out.width='100%'}
