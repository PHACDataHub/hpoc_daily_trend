        ...
        footnote(., i=1, j=11, value = as_paragraph(
          ...
          footnote(., value = as_paragraph(
              if(any_non_report_flag==FALSE){
                ...
                paste0("Note that daily updates were not provided by: ",str_c(key_PTs_nonreport, collapse=", "),". For calculation of the national 7MA of cases and deaths, days after the date of last report for these PTs were omitted.")
                }),
            ref_symbols = c(""),
            part = "header") %>%
