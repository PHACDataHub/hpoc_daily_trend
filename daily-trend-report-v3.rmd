...
ft_1 <- footnote(ft, value = as_paragraph(c("As of February 1st, test-based rather than person-based laboratory testing metrics are reported in this Figure/Table (see details in last slide).")),
                ref_symbols = c("")) %>%
