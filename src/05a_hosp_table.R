...
hosp_metrics1[hosp_metrics1$prname=="Canada"&hosp_metrics1$date==Sys.Date(),"hosp7ma"]<-corrected_Can_stats[1]
...
hosp_metrics2[hosp_metrics2$prname=="Canada"&hosp_metrics2$date==Sys.Date(),"icu7ma"]<-as.numeric(corrected_Can_stats[2])
